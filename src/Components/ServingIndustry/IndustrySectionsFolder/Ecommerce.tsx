...
const Ecommerce = () => {
    return (
        <div className="bg-teal-50 min-h-screen flex flex-col">
            {/* Header Section */}
            <header className="bg-gradient-to-r from-teal-700 to-teal-500 text-white text-center py-16">
                <h1 className="text-6xl font-extrabold animate-bounce">Elevate Your eCommerce with Metla</h1>
                <p className="mt-4 text-xl">Tailored staffing solutions to fuel your business growth.</p>
            </header>
            ...
            {/* How Metla Supports eCommerce Section */}
            <section className="max-w-7xl mx-auto px-6 my-12 text-center">
                <h2 className="text-4xl font-bold text-teal-900 mb-6">Unlock New Possibilities</h2>
                ...
                <img 
                    ...
                    className="w-full rounded-lg shadow-lg mb-8 transition-transform transform hover:scale-105"
                />
                <button className="bg-teal-700 text-white px-6 py-3 rounded-md shadow-lg hover:bg-teal-800 transition duration-300">
                    Explore Our Services
                </button>
            </section>
            ...
            <section className="py-1">
                <div className="max-w-5xl mx-auto text-center">
                    <h2 className="text-4xl font-bold text-teal-900 mb-6">Tailored Staffing Solutions Just for You</h2>
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 mb-8">
                        <div className="bg-white rounded-lg shadow-lg p-8 transition-transform transform hover:scale-105">
                            <h3 className="text-2xl font-semibold text-teal-700 mb-2">Expert Talent Acquisition</h3>
                            <p className="text-teal-800">Identify and recruit top professionals for your eCommerce needs.</p>
                        </div>
                        <div className="bg-white rounded-lg shadow-lg p-8 transition-transform transform hover:scale-105">
                            <h3 className="text-2xl font-semibold text-teal-700 mb-2">Flexible Workforce Solutions</h3>
                            <p className="text-teal-800">Adapt your team size to meet project demands seamlessly.</p>
                        </div>
                        <div className="bg-white rounded-lg shadow-lg p-8 transition-transform transform hover:scale-105">
                            <h3 className="text-2xl font-semibold text-teal-700 mb-2">Market Insights</h3>
                            <p className="text-teal-800">Gain insights to make informed hiring decisions.</p>
                        </div>
                    </div>
                </div>
            </section>
