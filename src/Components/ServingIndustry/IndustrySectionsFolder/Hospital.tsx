...
//         <h1 className="text-white text-5xl font-bold mb-4">Trusted Healthcare Staffing</h1>
...
//         <Link 
//           to='/contact' 
//           className="bg-white hover:bg-gray-200 text-[#147971] py-3 px-6 rounded-full font-medium transition">
//           Get Started
//         </Link>
//       </header>
...
//           <h2 className="text-3xl font-semibold mb-4 text-[#147971]">Our Staffing Solutions</h2>
...
//               // { title: "Certified Nursing Assistants", description: "Supportive CNAs enhancing patient experiences." },
...
//             ].map((service, index) => (
//               <li key={index} className="p-6 bg-white shadow-md rounded-lg hover:shadow-xl transition">
//                 <h3 className="text-xl font-semibold text-[#147971] mb-2">{service.title}</h3>
//                 <p className="text-gray-600 mb-4">{service.description}</p>
//                 <Link to='/service-details' className="text-[#147971] hover:underline">Learn More</Link>
//               </li>
//             ))}
//           </ul>
//         </div>
