  ...
  return (
    <div className="relative bg-gray-50">
      ...
      <section
        ...
        style={{ backgroundImage: `url(${softwareBackground})` }}
      >
        ...
        <div className="relative z-10 w-full max-w-4xl mx-auto text-center p-8 hero-text">
          ...
          <p className="text-lg text-gray-200 mb-8 max-w-2xl mx-auto">
            We build scalable and customized software solutions to meet your
            business needs and ensure future growth. Let's transform your vision
            into reality with innovative technologies.
          </p>
          <Link to="/contact">
      ...
      <section className="features-section py-20 bg-white">
        <div className="container mx-auto max-w-screen-xl px-4 overflow-hidden">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
            {featureCards.map((feature, index) => (
              <div
                key={index}
                className="feature-card group bg-white p-8 rounded-xl shadow-lg transition-transform transform hover:scale-105 hover:shadow-2xl text-center border border-transparent hover:border-cyan-500"
              >
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 mt-4 max-w-2xl mx-auto">
              We believe that no two businesses are alike. Our bespoke software
              solutions are designed to align with your business objectives,
